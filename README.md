...
<br>
Because the training and the validation loss are less different - that means we can extent the hyperParameters to increase the model's performance which would drive the loss down. However training and validation loss would start to decay almost exponentially!
