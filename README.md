...
<br>
Because the training loss and the validation loss are less different - that means we can extent the hyperParameters to increase the model's performance which would drive the loss down.
